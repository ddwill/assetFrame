...
public class EditorScenceData
{
	...
	private void separateSavedGameObject(EditorScenceItemData itemData)
	{
		...
		if (obj != null&&(prefabaType== PrefabType.Prefab||prefabaType== PrefabType.ModelPrefab
		                  || prefabaType== PrefabType.PrefabInstance||prefabaType== PrefabType.ModelPrefabInstance)) 
		{
